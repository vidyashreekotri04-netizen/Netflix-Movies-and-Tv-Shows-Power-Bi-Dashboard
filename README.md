...
Netflix Movies and Tv Shows Dashboard (PowerBI-Dashboard)
...
________________________________________
Data Pipeline
1.	Collected dataset (CSV format)
2.	Imported data into Power BI
3.	Cleaned data using Power Query (handled null values, formatting)
4.	Created calculated columns and measures using DAX
5.	Built visualizations and dashboard layout
6.	Published final interactive dashboard
________________________________________
Dashboard Features
•	KPI Cards:
o	Total titles
...
•	United States has the highest number of titles, followed by India
________________________________________
